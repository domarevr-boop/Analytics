...
export default function GeographyPage() {
  ...
  if (!records.length) return <section className="geo-page analytics-empty-page">
    <header className="geo-header"><div><span className="geo-eyebrow">АНАЛИТИКА</span><h1>География заказов</h1><p>Объём заказов, сроки доставки и распределение спроса по территориям.</p></div><button type="button" className="analytics-help-toggle" onClick={() => setShowHelp(true)}>Справка</button></header>
