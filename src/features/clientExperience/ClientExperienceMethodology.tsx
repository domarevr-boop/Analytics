    ...
    <div className="cx-methodology-page">
      ...
      <section id="cx-glossary" className="page-card cx-methodology-section">
        ...
        <div className="cx-glossary-grid">
          ...
          <Glossary term="Overall CXI" text="Взвешенная тональность всех тем по числу оценочных упоминаний. Шкала 0–100." />
          <Glossary term="Вклад в CXI" text="Вес оценочных упоминаний темы среди всех тем × её тональность. Сумма вкладов образует Overall CXI." />
          <Glossary term="Δ вклада" text="Изменение вклада темы относительно предыдущего равного периода; показывает драйверы роста и снижения Overall CXI." />
