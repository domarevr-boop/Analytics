...
comment on function public.v5_market_batch_history(integer) is 'Bounded V5 Market import history with a private Storage path for an authorized source-file download.';
