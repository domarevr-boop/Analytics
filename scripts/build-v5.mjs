...
const run = (args) => {
  const result = spawnSync(process.execPath, args, {
    ...
    env: {
      ...
      VITE_V5_GEOGRAPHY_BACKEND_ENABLED: 'true',
      VITE_V5_ENTRY_POINTS_IMPORT_ENABLED: 'true',
      VITE_V5_ENTRY_POINTS_BACKEND_ENABLED: 'true',
      VITE_V5_FUNNEL_BACKEND_ENABLED: 'true',
      VITE_V5_FUNNEL_IMPORT_ENABLED: 'true',
      VITE_V5_PROFITABILITY_BACKEND_ENABLED: 'true',
